-- TODO Anki
-- Friends Request 1: Overall Acceptance Rate
Table: FriendRequest
...
--
Select 
	case b.countAccepted
		when 0 then 0.00
		else round(b.countAccepted/ a.countTotal,2) 
	end accept_rate from 
	(Select count(*) as countTotal from 
		(Select distinct sender_id, send_to_id from FriendRequest) x) a, 
	(Select count(*) as countAccepted from 
		(Select distinct requester_id, accepter_id from RequestAccepted) y) b;